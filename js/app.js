// alert("Hello, World!"); -compliance test
...
//var booleanTruthy = 'true'; 
//var booleanFalsy; 
/* if(booleanTruthy){       --returns true
    alert("It was true");
} */
/* if(booleanFalsy){        --returns false
    alert("It was true");
} 
*/

//Basic Javascript Collections
// Array --orderd collection using numerical index. iteration order guaranteed.
// var array = [
// ];

//Object --unordered collection using key pairs. iteration order not guaranteed.
// var object = {
// };
